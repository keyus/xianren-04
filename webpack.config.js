...
const fs                = require('fs');
const pug_files         = path.resolve(`${__dirname}/src/pug`);        //pug 页面模板目录
...
//配置需要输出的html页面
let htmlpage= [
     // {filename: '10.html', template : './src/pug/10.pug', chunks : 'app' },
     // {filename: '11.html', template : './src/pug/11.pug', chunks : 'app' },
];
